      ...
      <div className="p-6 rounded-lg mb-6">
        ...
        <form action="" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
                ...
                <input type="password" className='w-full p-2 border rounded' name="password" value={formData.password} onChange={handleChange} />
            </div>
            <div className="mb-4">
            ...
            <tbody>
                {users.map((user)=>(
                    <tr key={user._id} className='border-b hover:bg-gray-50'>
                        ...
                        <td className="p-4"><select name="" value={user.role} className='p-2 border rounded' onChange={(e)=> handleRoleChange(user._id,e.target.value)} id="">
                        <option value="customer">Customer</option>    
                        <option value="admin">Admin</option>    
                        </select></td>
                        <td className="p-4">
