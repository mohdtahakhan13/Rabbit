...
//async thunk to fetch products from collections and optimal filters
...
const productsSlice=createSlice({
    ...
    initialState:{
        products:[],
        selectedProduct:null, //store the details of simgle Product
        similarProducts:[],
        loading:false,
        error:null,
        filters:{
            category:"",
            size:"",color:"",
            gender:"",brand:"",minPrice:"",maxPrice:"",sortBy:"",search:"",material:"",collection:"",
        }
    },
    reducers:{
